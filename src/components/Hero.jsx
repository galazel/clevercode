...
export default function Hero() {
  return (
    <section className="p-20 hero body-font mb-20 h-full bg-[url(https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=1920&fit=crop)] bg-cover bg-center">
